...
import (
	...
	"github.com/vinhph0906/blockchain-wallet/blockchain"
	"github.com/vinhph0906/blockchain-wallet/blockchain/wallet"
)
...
func (cli *CommandLine) printChain() {
	...
	for {
		...
		fmt.Printf("Hash: %x\n", block.Hash)
		transactions, _ := json.Marshal(block.Transactions)
